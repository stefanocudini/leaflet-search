...
//	in this mode every record can have a free structure of attributes, only 'loc' is required
  ...
  setLayer: function(layers) { //set search layer at runtime
		//this.options.layer = layer; //setting this, run only this._recordsFromLayer()
    var map = this._map;
    if (layers.searchGroup) {
      layers.searchGroup.forEach(function(group) {
...
//////end DOM creations
	...
	_recordsFromLayer: function() {	//return table: key,value from layer
		var that = this,
			...
			loc;
		var searchMarker = function(layer) {
    ...
    var context = this;
    if (context._layer.searchGroup) {
      context._layer.searchGroup.forEach(function(group) {
